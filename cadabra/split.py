...
def kin_ABI():
    ...
    ruleM7  = Ex(r''' M{7}_{a? b? c? d? e? f? g? h?}^{i? j?} -> \eta_{a? e?} \eta_{b? f?} \eta_{c? g?} \eta^{d? h?} \eta^{i? j?}''')
    ruleM8  = Ex(r''' M{8}_{a? b? c? d? e? f? g? h?}^{i? j?} -> \eta_{a? e?} \eta_{b? f?} \eta_{c? g?} \delta_{d?}^{i?} \delta_{h?}^{j?}''')
    ruleM9  = Ex(r''' M{9}_{a? b? c? d? e? f? g? h?}^{i? j?} -> \eta_{a? e?} \eta_{b? g?} \eta_{c? f?} \eta^{d? h?} \eta^{i? j?}''')
    ...
    ruleM14 = Ex(r''' M{14}_{a? b? c? d? e? f? g? h?}^{i? j?} -> -\eta^{i? p} \epsilon_{a? b? e? p} \eta_{c? f?} \eta_{d? g?} \delta_{h?}^{j?}''')
    ruleM15 = Ex(r''' M{15}_{a? b? c? d? e? f? g? h?}^{i? j?} -> -\eta^{i? p} \epsilon_{a? b? e? p} \eta_{c? g?} \eta_{d? h?} \delta_{f?}^{j?}''')
...
def kin_ApBq():
    ruleM1  = Ex(r''' M{1}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \eta_{a? c?} \eta_{b? d?} \delta_{f?}^{e?} \eta_{g? h?} \delta_{i?}^{j?}''')
    ...
    ruleM4  = Ex(r''' M{4}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \eta_{a? c?} \eta_{b? f?} \eta_{d? h?} \delta_{g?}^{e?} \delta_{i?}^{j?}''')
    ruleM5  = Ex(r''' M{5}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \eta_{a? c?} \eta_{b? f?} \eta_{d? h?} \eta^{e? j?} \eta_{g? i?}''')
    ruleM6  = Ex(r''' M{6}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \eta_{a? c?} \eta_{b? f?} \delta_{d?}^{j?} \delta_{h?}^{e?} \eta_{g? i?}''')
    ...
    ruleM10 = Ex(r''' M{10}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> -\epsilon_{a? b? c? d?} \delta_{f?}^{e?} \eta_{g? h?} \delta_{i?}^{j?}''')
