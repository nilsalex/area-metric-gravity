...
def apply_sol(ex):
  ...
  substitute(ex, Ex(r'''e{7} -> (-2)*k{7} + 1/16*k{16}'''))
  substitute(ex, Ex(r'''e{8} -> 1/6*k{5} + 1/3*k{6} + (-1/3)*k{7} + (-1/96)*k{16}'''))
  substitute(ex, Ex(r'''e{9} -> (-1)*k{4}'''))
  substitute(ex, Ex(r'''e{10} -> (-2)*k{5} + (-1)*k{6} + (-4)*k{7} + 5/32*k{16}'''))
  substitute(ex, Ex(r'''e{11} -> (-1)*k{4} + 1/16*k{16}'''))
  substitute(ex, Ex(r'''e{12} -> 1*k{4}'''))
  substitute(ex, Ex(r'''e{13} -> 1*k{5}'''))
  substitute(ex, Ex(r'''e{14} -> 1*k{4} + (-1/8)*k{16}'''))
  substitute(ex, Ex(r'''e{15} -> 1*k{6}'''))
  substitute(ex, Ex(r'''e{16} -> 1*k{7}'''))
  substitute(ex, Ex(r'''e{17} -> 1*k{8}'''))
  substitute(ex, Ex(r'''e{18} -> (-2)*k{5} + 2*k{6} + (-8)*k{7} + 12*k{8} + 4*k{9} + 1/16*k{16}'''))
  substitute(ex, Ex(r'''e{19} -> (-1)*k{5} + 1*k{6} + (-4)*k{7} + 6*k{8} + 2*k{9} + 1/32*k{16}'''))
  substitute(ex, Ex(r'''e{20} -> 1*k{9}'''))
  substitute(ex, Ex(r'''e{21} -> (-1)*k{5} + 1*k{6} + (-4)*k{7} + 6*k{8} + 2*k{9} + 1/32*k{16}'''))
  substitute(ex, Ex(r'''e{22} -> 1*k{10}'''))
  substitute(ex, Ex(r'''e{23} -> 1*k{11}'''))
  substitute(ex, Ex(r'''e{24} -> 1*k{12}'''))
  substitute(ex, Ex(r'''e{25} -> (-2)*k{7} + (-6)*k{10} + (-3)*k{11} + (-1/2)*k{12} + 3/2*k{13} + (-1/32)*k{16}'''))
  substitute(ex, Ex(r'''e{26} -> (-3)*k{10} + (-3/2)*k{11} + (-1/4)*k{12} + 3/4*k{13} + (-1/64)*k{16}'''))
  substitute(ex, Ex(r'''e{27} -> (-3/2)*k{7} + (-3/2)*k{10} + (-3/4)*k{11} + (-5/8)*k{12} + (-1/8)*k{13} + 5/128*k{16}'''))
  substitute(ex, Ex(r'''e{28} -> 2*k{7} + 6*k{10} + 3*k{11} + 1/2*k{12} + (-3/2)*k{13} + (-1/32)*k{16}'''))
  substitute(ex, Ex(r'''e{29} -> 1*k{13}'''))
  substitute(ex, Ex(r'''e{30} -> 2*k{7} + 6*k{10} + 3*k{11} + 1/2*k{12} + (-3/2)*k{13} + (-1/32)*k{16}'''))
  substitute(ex, Ex(r'''e{31} -> (-1/12)*k{7} + (-1/4)*k{10} + 1/8*k{11} + (-1/16)*k{12} + (-1/16)*k{13} + (-1/6)*k{14} + 1/256*k{16}'''))
  substitute(ex, Ex(r'''e{32} -> 1/6*k{7} + 1/2*k{10} + (-1/4)*k{11} + 1/24*k{12} + (-1/8)*k{13} + (-1/3)*k{15} + (-1/384)*k{16}'''))
  substitute(ex, Ex(r'''e{33} -> 1*k{14}'''))
  substitute(ex, Ex(r'''e{34} -> 1*k{15}'''))
  substitute(ex, Ex(r'''e{35} -> 1*k{15}'''))
  substitute(ex, Ex(r'''e{36} -> 1/6*k{7} + (-1/24)*k{12} + (-1/8)*k{13} + (-1/6)*k{14} + (-1/12)*k{15} + 1/384*k{16}'''))
  substitute(ex, Ex(r'''e{37} -> (-1/2)*k{7}'''))
  substitute(ex, Ex(r'''e{38} -> 16*k{7} + (-1/2)*k{16}'''))
  substitute(ex, Ex(r'''e{39} -> 1*k{16}'''))
  substitute(ex, Ex(r'''e{40} -> (-8)*k{7}'''))
  return(ex)
