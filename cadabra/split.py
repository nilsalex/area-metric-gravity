...
def kin_ABI():
    ...
    ruleM2  = Ex(r''' M{2}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? d?} \eta_{e? g?} \eta_{f? i?} \eta_{h? j?}''')
    ruleM3  = Ex(r''' M{3}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? e?} \eta_{d? g?} \eta_{f? h?} \eta_{i? j?}''')
    ruleM4  = Ex(r''' M{4}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? e?} \eta_{d? g?} \eta_{f? i?} \eta_{h? j?}''')
    ruleM5  = Ex(r''' M{5}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? e?} \eta_{d? i?} \eta_{f? g?} \eta_{h? j?}''')
    ruleM6  = Ex(r''' M{6}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? i?} \eta_{d? j?} \eta_{e? g?} \eta_{f? h?}''')
    ruleM7  = Ex(r''' M{7}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? f?} \eta_{c? g?} \eta_{d? h?} \eta_{i? j?}''')
    ruleM8  = Ex(r''' M{8}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? f?} \eta_{c? g?} \eta_{d? i?} \eta_{h? j?}''')
    ruleM9  = Ex(r''' M{9}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? g?} \eta_{c? f?} \eta_{d? h?} \eta_{i? j?}''')
    ruleM10 = Ex(r''' M{10}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? c? d?} \eta_{e? g?} \eta_{f? h?} \eta_{i? j?}''')
    ruleM11 = Ex(r''' M{11}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? c? d?} \eta_{e? g?} \eta_{f? i?} \eta_{h? j?}''')
    ruleM12 = Ex(r''' M{12}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? f?} \eta_{c? g?} \eta_{d? h?} \eta_{i? j?}''')
    ruleM13 = Ex(r''' M{13}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? f?} \eta_{c? g?} \eta_{d? i?} \eta_{h? j?}''')
    ruleM14 = Ex(r''' M{14}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? i?} \eta_{c? f?} \eta_{d? g?} \eta_{h? j?}''')
    ruleM15 = Ex(r''' M{15}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? i?} \eta_{c? g?} \eta_{d? h?} \eta_{f? j?}''')
    ruleM16 = Ex(r''' M{16}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{e? f? g? h?} \eta_{a? c?} \eta_{b? d?} \eta_{i? j?}''')
