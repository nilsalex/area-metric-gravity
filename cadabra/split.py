...
def mass_AB():
    ...
    ruleM2  = Ex(r''' M{1}^{a? b? c? d? e? f? g? h?} -> \eta^{a? c?} \eta^{b? e?} \eta^{d? g?} \eta^{f? h?}''')
    ruleM3  = Ex(r''' M{1}^{a? b? c? d? e? f? g? h?} -> \eta^{a? e?} \eta^{b? f?} \eta^{c? g?} \eta^{d? h?}''')
    ruleM4  = Ex(r''' M{1}^{a? b? c? d? e? f? g? h?} -> \eta^{a? e?} \eta^{b? g?} \eta^{c? f?} \eta^{d? h?}''')
    ruleM5  = Ex(r''' M{1}^{a? b? c? d? e? f? g? h?} -> \epsilon^{a? b? c? d?} \eta^{e? g?} \eta^{f? h?}''')
    ruleM6  = Ex(r''' M{1}^{a? b? c? d? e? f? g? h?} -> \epsilon^{a? b? e? f?} \eta^{c? g?} \eta^{d? h?}''')
