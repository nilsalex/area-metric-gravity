...
def kin_ABI():
    ...
    ruleM3  = Ex(r''' M{3}_{a? b? c? d? e? f? g? h?}^{i? j?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \eta_{f? h?} \delta^{i? j?}''')
    ...
    ruleM7  = Ex(r''' M{7}_{a? b? c? d? e? f? g? h?}^{i? j?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? g?} \eta_{d? h?} \delta^{i? j?}''')
    ruleM8  = Ex(r''' M{8}_{a? b? c? d? e? f? g? h?}^{i? j?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? g?} \delta_{d?}^{i?} \delta_{h?}^{j?}''')
    ruleM9  = Ex(r''' M{9}_{a? b? c? d? e? f? g? h?}^{i? j?}  -> \eta_{a? e?} \eta_{b? g?} \eta_{c? f?} \eta_{d? h?} \delta^{i? j?}''')
...
def kin_ApBq():
    ...
    ruleM2  = Ex(r''' M{2}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?}  -> \eta_{a? c?} \eta_{b? d?} \delta^{e? j?} \eta_{f? h?} \eta_{g? i?}''')
    ...
    ruleM5  = Ex(r''' M{5}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?}  -> \eta_{a? c?} \eta_{b? f?} \eta_{d? h?} \delta^{e? j?} \eta_{g? i?}''')
    ...
    ruleM9  = Ex(r''' M{9}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?}  -> \eta_{a? f?} \eta_{b? g?} \eta_{c? h?} \eta_{d? i?} \delta^{e? j?}''')
    ruleM10 = Ex(r''' M{10}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \epsilon_{a? b? c? d?} \delta^{e?}_{f?} \eta_{g? h?} \delta_{i?}^{j?}''')
    ruleM11 = Ex(r''' M{11}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \epsilon_{a? b? c? d?} \delta^{e? j?} \eta_{f? h?} \eta_{g? i?}''')
    ...
    ruleM15 = Ex(r''' M{15}_{a? b? c? d?}^{e?}_{f? g? h? i?}^{j?} -> \epsilon_{a? b? f? g?} \eta_{c? h?} \eta_{d? i?} \delta^{e? j?}''')
