...
Symmetric(Ex(r'''B^{\alpha}'''), Ex(r'''''') )
Symmetric(Ex(r'''dB^{\alpha}'''), Ex(r'''''') )
...
Depends(Ex(r'''dW1'''), Ex(r'''\partial{#})''') )
Depends(Ex(r'''dW2'''), Ex(r'''\partial{#})''') )

SortOrder(Ex(r'''{dU{#},dV{#},dW{#},dB{#},dA,m{#},k{#},t{#},e{#},A,B{#},U{#},V{#},W{#},U1,U2,V1,V2,W1,W2,\partial{#},\epsilon{#},\gamma{#}}'''), Ex(r''')''') )

ruleH1  = Ex(r''' H1_{\mu \nu} -> -1/2 * \gamma_{\alpha \mu} \gamma_{\beta \nu} (U^{\alpha \beta} + V^{\alpha \beta})''')
ruleH2  = Ex(r''' H2_{\mu \nu \rho} -> 1/4 * \epsilon_{\mu \nu \rho} \gamma_{\alpha \beta} (U^{\alpha \beta} + V^{\alpha \beta}) - 1/2 * \epsilon_{\alpha \nu \rho} \gamma_{\beta \mu} W^{\alpha \beta} + 1/2 * \gamma_{\mu \nu} \gamma_{\rho \alpha} B^{\alpha} - 1/2 * \gamma_{\mu \rho} \gamma_{\nu \alpha} B^{\alpha}''')
ruleH3  = Ex(r''' H3_{\mu \nu \rho \sigma} -> -1/2 * (\gamma_{\mu \rho} \gamma_{\nu \sigma} - \gamma_{\mu \sigma} \gamma_{\nu \rho}) \gamma_{\alpha \beta} (U^{\alpha \beta} + V^{\alpha \beta}) - 1/2 * \epsilon_{\alpha \mu \nu} \epsilon_{\beta \rho \sigma} (U^{\alpha \beta} - V^{\alpha \beta})''')
...
ruleEtaEpsilon1 = Ex(r'''\eta_{a? p} \epsilon^{p \alpha \beta \gamma} -> -\delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon2 = Ex(r'''\eta_{p a?} \epsilon^{p \alpha \beta \gamma} -> -\delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon3 = Ex(r'''\eta_{a? p} \epsilon^{\alpha p \beta \gamma} -> \delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon4 = Ex(r'''\eta_{p a?} \epsilon^{\alpha p \beta \gamma} -> \delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon5 = Ex(r'''\eta_{a? p} \epsilon^{\alpha \beta p \gamma} -> -\delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon6 = Ex(r'''\eta_{p a?} \epsilon^{\alpha \beta p \gamma} -> -\delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon7 = Ex(r'''\eta_{a? p} \epsilon^{\alpha \beta \gamma p} -> \delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
ruleEtaEpsilon8 = Ex(r'''\eta_{p a?} \epsilon^{\alpha \beta \gamma p} -> \delta^{0}_{a?} \epsilon^{\alpha \beta \gamma}''')
...
def kin_ABI():
    ...
    ruleM5  = Ex(r''' M{5}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? e?} \eta^{d? i?} \eta^{f? g?} \eta^{h? j?}''')
    ruleM6  = Ex(r''' M{6}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? i?} \eta^{d? j?} \eta^{e? g?} \eta^{f? h?}''')
    ruleM7  = Ex(r''' M{7}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? f?} \eta^{c? g?} \eta^{d? h?} \eta^{i? j?}''')
    ruleM8  = Ex(r''' M{8}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? f?} \eta^{c? g?} \eta^{d? i?} \eta^{h? j?}''')
    ruleM9  = Ex(r''' M{9}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? g?} \eta^{c? f?} \eta^{d? h?} \eta^{i? j?}''')
    ...
    ruleM14 = Ex(r''' M{14}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? i?} \eta^{c? f?} \eta^{d? g?} \eta^{h? j?}''')
    ruleM15 = Ex(r''' M{15}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? i?} \eta^{c? g?} \eta^{d? h?} \eta^{f? j?}''')
    ruleM16 = Ex(r''' M{16}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{e? f? g? h?} \eta^{a? c?} \eta^{b? d?} \eta^{i? j?}''')
...
def subs_eta_epsilon(ex):
    substitute(ex, Ex(r'''\eta_{0 a} \epsilon^{p? q? r? a} -> -\epsilon^{p? q? r? 0}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{0 a} \epsilon^{p? q? a r?} -> -\epsilon^{p? q? 0 r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{0 a} \epsilon^{p? a q? r?} -> -\epsilon^{p? 0 q? r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{0 a} \epsilon^{a p? q? r?} -> -\epsilon^{0 p? q? r?}'''), repeat=True)

    substitute(ex, Ex(r'''\eta_{a 0} \epsilon^{p? q? r? a} -> -\epsilon^{p? q? r? 0}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{a 0} \epsilon^{p? q? a r?} -> -\epsilon^{p? q? 0 r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{a 0} \epsilon^{p? a q? r?} -> -\epsilon^{p? 0 q? r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{a 0} \epsilon^{a p? q? r?} -> -\epsilon^{0 p? q? r?}'''), repeat=True)

    substitute(ex, Ex(r'''\eta_{\alpha a} \epsilon^{p? q? r? a} -> \gamma_{\alpha \mu} \epsilon^{p? q? r? \mu}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{\alpha a} \epsilon^{p? q? a r?} -> \gamma_{\alpha \mu} \epsilon^{p? q? \mu r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{\alpha a} \epsilon^{p? a q? r?} -> \gamma_{\alpha \mu} \epsilon^{p? \mu q? r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{\alpha a} \epsilon^{a p? q? r?} -> \gamma_{\alpha \mu} \epsilon^{\mu p? q? r?}'''), repeat=True)

    substitute(ex, Ex(r'''\eta_{a \alpha} \epsilon^{p? q? r? a} -> \gamma_{\alpha \mu} \epsilon^{p? q? r? \mu}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{a \alpha} \epsilon^{p? q? a r?} -> \gamma_{\alpha \mu} \epsilon^{p? q? \mu r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{a \alpha} \epsilon^{p? a q? r?} -> \gamma_{\alpha \mu} \epsilon^{p? \mu q? r?}'''), repeat=True)
    substitute(ex, Ex(r'''\eta_{a \alpha} \epsilon^{a p? q? r?} -> \gamma_{\alpha \mu} \epsilon^{\mu p? q? r?}'''), repeat=True)
...
def kin_ApBq():
    ...
    ruleM2  = Ex(r''' M{2}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? d?} \eta^{e? j?} \eta^{f? i?} \eta^{g? h?}''')
    ruleM3  = Ex(r''' M{3}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? e?} \eta^{d? f?} \eta^{g? h?} \eta^{i? j?}''')
    ruleM4  = Ex(r''' M{4}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? f?} \eta^{d? h?} \eta^{e? g?} \eta^{i? j?}''')
    ruleM5  = Ex(r''' M{5}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? f?} \eta^{d? h?} \eta^{e? j?} \eta^{g? i?}''')
    ruleM6  = Ex(r''' M{6}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? c?} \eta^{b? f?} \eta^{d? j?} \eta^{e? h?} \eta^{g? i?}''')
    ruleM7  = Ex(r''' M{7}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? f?} \eta^{c? g?} \eta^{d? h?} \eta^{i? j?}''')
    ruleM8  = Ex(r''' M{8}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? e?} \eta^{b? f?} \eta^{c? h?} \eta^{d? i?} \eta^{g? j?}''')
    ruleM9  = Ex(r''' M{9}^{a? b? c? d? e? f? g? h? i? j?} -> \eta^{a? f?} \eta^{b? g?} \eta^{c? h?} \eta^{d? i?} \eta^{e? j?}''')
    ...
    ruleM12 = Ex(r''' M{12}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? f?} \eta^{c? g?} \eta^{d? h?} \eta^{i? j?}''')
    ruleM13 = Ex(r''' M{13}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? e? f?} \eta^{c? h?} \eta^{d? j?} \eta^{g? i?}''')
    ruleM14 = Ex(r''' M{14}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? f? g?} \eta^{c? e?} \eta^{d? h?} \eta^{i? j?}''')
    ruleM15 = Ex(r''' M{15}^{a? b? c? d? e? f? g? h? i? j?} -> \epsilon^{a? b? f? g?} \eta^{c? h?} \eta^{d? i?} \eta^{e? j?}''')
...
def tt(ex):
  ...
  substitute(ex, Ex(r'''\partial_{\mu \nu}{V^{\nu \mu}} -> 0'''))
  substitute(ex, Ex(r'''\partial_{\mu \nu}{W^{\nu \mu}} -> 0'''))
  substitute(ex, Ex(r'''\partial_{\mu}{B^{\mu}} -> 0'''))
  substitute(ex, Ex(r'''\partial_{p? \mu}{B^{\mu}} -> 0'''))
  substitute(ex, Ex(r'''\partial_{\mu p?}{B^{\mu}} -> 0'''))
...
def scalar(ex):
  ...
  substitute(ex, Ex(r'''W^{\mu \nu} -> \gamma^{\mu \nu} W1 + (\gamma^{\mu \alpha} \gamma^{\nu \beta} - 1/3 * \gamma^{\mu \nu} \gamma^{\alpha \beta}) \partial_{\alpha \beta}{W2}'''))

  substitute(ex, Ex(r'''B^{\mu} -> 0'''))
