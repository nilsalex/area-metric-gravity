...
def kin_ABCI():
    ruleM1  = Ex(r''' M{1}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \eta_{f? h?} \eta_{i? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM2  = Ex(r''' M{2}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \eta_{f? h?} \eta_{i? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM3  = Ex(r''' M{3}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \eta_{f? i?} \eta_{h? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM4  = Ex(r''' M{4}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \eta_{f? i?} \eta_{h? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM5  = Ex(r''' M{5}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \eta_{f? i?} \delta_{h?}^{m?} \eta_{j? k?} \delta_{l?}^{n?}''')
    ruleM6  = Ex(r''' M{6}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \delta_{f?}^{m?} \delta_{h?}^{n?} \eta_{i? k?} \eta_{j? l?}''')
    ruleM7  = Ex(r''' M{7}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? i?} \eta_{f? j?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM8  = Ex(r''' M{8}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? i?} \eta_{f? j?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM9  = Ex(r''' M{9}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? d?} \eta_{e? i?} \eta_{f? k?} \eta_{g? j?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM10  = Ex(r''' M{10}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \eta_{f? h?} \eta_{i? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM11  = Ex(r''' M{11}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \eta_{f? h?} \eta_{i? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM12  = Ex(r''' M{12}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \eta_{f? i?} \eta_{h? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM13  = Ex(r''' M{13}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \eta_{f? i?} \eta_{h? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM14  = Ex(r''' M{14}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \eta_{f? i?} \delta_{h?}^{m?} \eta_{j? k?} \delta_{l?}^{n?}''')
    ruleM15  = Ex(r''' M{15}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? g?} \delta_{f?}^{m?} \delta_{h?}^{n?} \eta_{i? k?} \eta_{j? l?}''')
    ruleM16  = Ex(r''' M{16}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? g?} \eta_{h? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM17  = Ex(r''' M{17}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? g?} \eta_{h? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM18  = Ex(r''' M{18}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? g?} \delta_{h?}^{m?} \eta_{j? k?} \delta_{l?}^{n?}''')
    ruleM19  = Ex(r''' M{19}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? j?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM20  = Ex(r''' M{20}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? j?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM21  = Ex(r''' M{21}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? k?} \eta_{g? j?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM22  = Ex(r''' M{22}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \eta_{f? k?} \eta_{g? l?} \delta_{h?}^{m?} \delta_{j?}^{n?}''')
    ruleM23  = Ex(r''' M{23}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \delta_{f?}^{m?} \eta_{g? j?} \eta_{h? k?} \delta_{l?}^{n?}''')
    ruleM24  = Ex(r''' M{24}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \delta_{f?}^{m?} \eta_{g? k?} \eta_{h? l?} \delta_{j?}^{n?}''')
    ruleM25  = Ex(r''' M{25}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \eta_{d? i?} \delta_{f?}^{m?} \eta_{g? k?} \delta_{h?}^{n?} \eta_{j? l?}''')
    ruleM26  = Ex(r''' M{26}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \delta_{d?}^{m?} \eta_{f? g?} \delta_{h?}^{n?} \eta_{i? k?} \eta_{j? l?}''')
    ruleM27  = Ex(r''' M{27}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? e?} \delta_{d?}^{m?} \eta_{f? i?} \eta_{g? j?} \eta_{h? k?} \delta_{l?}^{n?}''')
    ruleM28  = Ex(r''' M{28}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? i?} \eta_{d? k?} \eta_{e? g?} \delta_{f?}^{m?} \delta_{h?}^{n?} \eta_{j? l?}''')
    ruleM29  = Ex(r''' M{29}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? c?} \eta_{b? i?} \eta_{d? k?} \eta_{e? j?} \delta_{f?}^{m?} \eta_{g? l?} \delta_{h?}^{n?}''')
    ruleM30  = Ex(r''' M{30}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? g?} \eta_{d? h?} \eta_{i? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM31  = Ex(r''' M{31}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? g?} \eta_{d? h?} \eta_{i? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM32  = Ex(r''' M{32}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? i?} \eta_{d? j?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM33  = Ex(r''' M{33}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? i?} \eta_{d? j?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM34  = Ex(r''' M{34}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? f?} \eta_{c? i?} \eta_{d? k?} \eta_{g? j?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM35  = Ex(r''' M{35}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? g?} \eta_{c? f?} \eta_{d? h?} \eta_{i? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM36  = Ex(r''' M{36}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? g?} \eta_{c? f?} \eta_{d? h?} \eta_{i? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM37  = Ex(r''' M{37}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? g?} \eta_{c? i?} \eta_{d? j?} \eta_{f? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM38  = Ex(r''' M{38}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? g?} \eta_{c? i?} \eta_{d? j?} \eta_{f? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM39  = Ex(r''' M{39}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta_{a? e?} \eta_{b? i?} \eta_{c? g?} \eta_{d? k?} \delta_{f?}^{m?} \delta_{h?}^{n?} \eta_{j? l?}''')
    ruleM40  = Ex(r''' M{40}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? g?} \eta_{f? h?} \eta_{i? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM41  = Ex(r''' M{41}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? g?} \eta_{f? h?} \eta_{i? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM42  = Ex(r''' M{42}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? g?} \eta_{f? i?} \eta_{h? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM43  = Ex(r''' M{43}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? g?} \eta_{f? i?} \eta_{h? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM44  = Ex(r''' M{44}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? g?} \eta_{f? i?} \delta_{h?}^{m?} \eta_{j? k?} \delta_{l?}^{n?}''')
    ruleM45  = Ex(r''' M{45}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? g?} \delta_{f?}^{m?} \delta_{h?}^{n?} \eta_{i? k?} \eta_{j? l?}''')
    ruleM46  = Ex(r''' M{46}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? i?} \eta_{f? j?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM47  = Ex(r''' M{47}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? i?} \eta_{f? j?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM48  = Ex(r''' M{48}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? c? d?} \eta_{e? i?} \eta_{f? k?} \eta_{g? j?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM49  = Ex(r''' M{49}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? g?} \eta_{d? h?} \eta_{i? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM50  = Ex(r''' M{50}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? g?} \eta_{d? h?} \eta_{i? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM51  = Ex(r''' M{51}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? g?} \eta_{d? i?} \eta_{h? k?} \eta_{j? l?} \eta^{m? n?}''')
    ruleM52  = Ex(r''' M{52}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? g?} \eta_{d? i?} \eta_{h? k?} \delta_{j?}^{m?} \delta_{l?}^{n?}''')
    ruleM53  = Ex(r''' M{53}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? g?} \eta_{d? i?} \delta_{h?}^{m?} \eta_{j? k?} \delta_{l?}^{n?}''')
    ruleM54  = Ex(r''' M{54}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? g?} \delta_{d?}^{m?} \delta_{h?}^{n?} \eta_{i? k?} \eta_{j? l?}''')
    ruleM55  = Ex(r''' M{55}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? i?} \eta_{d? j?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM56  = Ex(r''' M{56}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? i?} \eta_{d? j?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM57  = Ex(r''' M{57}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? f?} \eta_{c? i?} \eta_{d? k?} \eta_{g? j?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM58  = Ex(r''' M{58}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \eta_{d? j?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM59  = Ex(r''' M{59}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \eta_{d? j?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM60  = Ex(r''' M{60}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \eta_{d? k?} \eta_{g? j?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM61  = Ex(r''' M{61}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \eta_{d? k?} \eta_{g? j?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM62  = Ex(r''' M{62}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \eta_{d? k?} \eta_{g? l?} \delta_{h?}^{m?} \delta_{j?}^{n?}''')
    ruleM63  = Ex(r''' M{63}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \delta_{d?}^{m?} \eta_{g? j?} \eta_{h? k?} \delta_{l?}^{n?}''')
    ruleM64  = Ex(r''' M{64}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \delta_{d?}^{m?} \eta_{g? k?} \eta_{h? l?} \delta_{j?}^{n?}''')
    ruleM65  = Ex(r''' M{65}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? e? i?} \eta_{c? f?} \delta_{d?}^{m?} \eta_{g? k?} \delta_{h?}^{n?} \eta_{j? l?}''')
    ruleM66  = Ex(r''' M{66}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta^{p m?} \epsilon_{a? b? e? p} \eta_{c? f?} \eta_{d? i?} \eta_{g? j?} \eta_{h? k?} \delta_{l?}^{n?}''')
    ruleM67  = Ex(r''' M{67}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? i? j?} \eta_{c? e?} \eta_{d? f?} \eta_{g? k?} \eta_{h? l?} \eta^{m? n?}''')
    ruleM68  = Ex(r''' M{68}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? i? j?} \eta_{c? e?} \eta_{d? f?} \eta_{g? k?} \delta_{h?}^{m?} \delta_{l?}^{n?}''')
    ruleM69  = Ex(r''' M{69}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{a? b? i? j?} \eta_{c? e?} \eta_{d? k?} \delta_{f?}^{m?} \eta_{g? l?} \delta_{h?}^{n?}''')
    ruleM70  = Ex(r''' M{70}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta^{p m?} \epsilon_{a? b? i? p} \eta_{c? e?} \eta_{d? f?} \eta_{g? j?} \eta_{h? k?} \delta_{l?}^{n?}''')
    ruleM71  = Ex(r''' M{71}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \eta^{p m?} \epsilon_{a? b? i? p} \eta_{c? e?} \eta_{d? f?} \eta_{g? k?} \eta_{h? l?} \delta_{j?}^{n?}''')
    ruleM72  = Ex(r''' M{72}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}  -> \epsilon_{i? j? k? l?} \eta_{a? c?} \eta_{b? d?} \eta_{e? g?} \eta_{f? h?} \eta^{m? n?}''')
    
    ruleM  = Ex(r''' M_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} -> e{1} * M{1}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{2} * M{2}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{3} * M{3}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{4} * M{4}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{5} * M{5}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{6} * M{6}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{7} * M{7}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{8} * M{8}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{9} * M{9}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{10} * M{10}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{11} * M{11}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{12} * M{12}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{13} * M{13}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{14} * M{14}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{15} * M{15}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{16} * M{16}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{17} * M{17}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{18} * M{18}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{19} * M{19}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{20} * M{20}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{21} * M{21}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{22} * M{22}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{23} * M{23}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{24} * M{24}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{25} * M{25}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{26} * M{26}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{27} * M{27}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{28} * M{28}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{29} * M{29}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{30} * M{30}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{31} * M{31}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{32} * M{32}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{33} * M{33}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{34} * M{34}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{35} * M{35}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{36} * M{36}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{37} * M{37}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{38} * M{38}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{39} * M{39}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{40} * M{40}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{41} * M{41}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{42} * M{42}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{43} * M{43}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{44} * M{44}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{45} * M{45}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{46} * M{46}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{47} * M{47}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{48} * M{48}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{49} * M{49}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{50} * M{50}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{51} * M{51}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{52} * M{52}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{53} * M{53}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{54} * M{54}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{55} * M{55}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{56} * M{56}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{57} * M{57}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{58} * M{58}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{59} * M{59}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{60} * M{60}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{61} * M{61}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{62} * M{62}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{63} * M{63}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{64} * M{64}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{65} * M{65}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{66} * M{66}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{67} * M{67}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{68} * M{68}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{69} * M{69}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{70} * M{70}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{71} * M{71}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?} + e{72} * M{72}_{a? b? c? d? e? f? g? h? i? j? k? l?}^{m? n?}''')
    ...
    ex  = Ex(r'''M_{a b c d e f g h i j k l}^{m n} H^{a b c d} H^{e f g h} \partial_{m n}{H^{i j k l}}''')
    ...
    substitute(ex, ruleM17)
    substitute(ex, ruleM18)
    substitute(ex, ruleM19)
    substitute(ex, ruleM20)
    substitute(ex, ruleM21)
    substitute(ex, ruleM22)
    substitute(ex, ruleM23)
    substitute(ex, ruleM24)
    substitute(ex, ruleM25)
    substitute(ex, ruleM26)
    substitute(ex, ruleM27)
    substitute(ex, ruleM28)
    substitute(ex, ruleM29)
    substitute(ex, ruleM30)
    substitute(ex, ruleM31)
    substitute(ex, ruleM32)
    substitute(ex, ruleM33)
    substitute(ex, ruleM34)
    substitute(ex, ruleM35)
    substitute(ex, ruleM36)
    substitute(ex, ruleM37)
    substitute(ex, ruleM38)
    substitute(ex, ruleM39)
    substitute(ex, ruleM40)
    substitute(ex, ruleM41)
    substitute(ex, ruleM42)
    substitute(ex, ruleM43)
    substitute(ex, ruleM44)
    substitute(ex, ruleM45)
    substitute(ex, ruleM46)
    substitute(ex, ruleM47)
    substitute(ex, ruleM48)
    substitute(ex, ruleM49)
    substitute(ex, ruleM50)
    substitute(ex, ruleM51)
    substitute(ex, ruleM52)
    substitute(ex, ruleM53)
    substitute(ex, ruleM54)
    substitute(ex, ruleM55)
    substitute(ex, ruleM56)
    substitute(ex, ruleM57)
    substitute(ex, ruleM58)
    substitute(ex, ruleM59)
    substitute(ex, ruleM60)
    substitute(ex, ruleM61)
    substitute(ex, ruleM62)
    substitute(ex, ruleM63)
    substitute(ex, ruleM64)
    substitute(ex, ruleM65)
    substitute(ex, ruleM66)
    substitute(ex, ruleM67)
    substitute(ex, ruleM68)
    substitute(ex, ruleM69)
    substitute(ex, ruleM70)
    substitute(ex, ruleM71)
    substitute(ex, ruleM72)
...
def shift(kinABI, kinApBq):
    substitute(kinABI, Ex(r'e{q??} -> f{q??}'))
    substitute(kinApBq, Ex(r'e{q??} -> f{q??}'))

    substitute(kinABI, Ex(r'f{1} -> e{22}'))
    substitute(kinABI, Ex(r'f{2} -> e{23}'))
    substitute(kinABI, Ex(r'f{3} -> e{24}'))
    substitute(kinABI, Ex(r'f{4} -> e{25}'))
    substitute(kinABI, Ex(r'f{5} -> e{26}'))
    substitute(kinABI, Ex(r'f{6} -> e{27}'))
    substitute(kinABI, Ex(r'f{7} -> e{28}'))
    substitute(kinABI, Ex(r'f{8} -> e{29}'))
    substitute(kinABI, Ex(r'f{9} -> e{30}'))
    substitute(kinABI, Ex(r'f{10} -> e{31}'))
    substitute(kinABI, Ex(r'f{11} -> e{32}'))
    substitute(kinABI, Ex(r'f{12} -> e{33}'))
    substitute(kinABI, Ex(r'f{13} -> e{34}'))
    substitute(kinABI, Ex(r'f{14} -> e{35}'))
    substitute(kinABI, Ex(r'f{15} -> e{36}'))
    substitute(kinABI, Ex(r'f{16} -> e{37}'))

    substitute(kinApBq, Ex(r'f{1} -> e{7}'))
    substitute(kinApBq, Ex(r'f{2} -> e{8}'))
    substitute(kinApBq, Ex(r'f{3} -> e{9}'))
    substitute(kinApBq, Ex(r'f{4} -> e{10}'))
    substitute(kinApBq, Ex(r'f{5} -> e{11}'))
    substitute(kinApBq, Ex(r'f{6} -> e{12}'))
    substitute(kinApBq, Ex(r'f{7} -> e{13}'))
    substitute(kinApBq, Ex(r'f{8} -> e{14}'))
    substitute(kinApBq, Ex(r'f{9} -> e{15}'))
    substitute(kinApBq, Ex(r'f{10} -> e{16}'))
    substitute(kinApBq, Ex(r'f{11} -> e{17}'))
    substitute(kinApBq, Ex(r'f{12} -> e{18}'))
